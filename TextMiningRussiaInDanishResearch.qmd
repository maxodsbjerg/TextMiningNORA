...
NORA makes it possible to search across the research and in this tutroail we will be working on research on Russia. Before venturing into this data we'll need to dwell a bit on our tool for analysis, R, and some libraries for R.
